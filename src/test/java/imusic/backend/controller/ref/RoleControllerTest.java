...
class RoleControllerTest {
    ...
    @Test
    @DisplayName("GET /api/ref/roles - success for ADMIN")
    @WithMockUser(roles = "ADMIN")
    void testGetAll() throws Exception {
        RoleResponseDto dto = new RoleResponseDto(1L, "TEST_CODE", "Test Name");
        when(service.getAll()).thenReturn(List.of(dto));

        mockMvc.perform(get("/api/ref/roles")
    ...
    @Test
    @DisplayName("GET /api/ref/roles/{id} - success for MANAGER")
    @WithMockUser(roles = "MANAGER")
    void testGetById() throws Exception {
        RoleResponseDto dto = new RoleResponseDto(1L, "TEST_CODE", "Test Name");
        when(service.getById(1L)).thenReturn(dto);

        mockMvc.perform(get("/api/ref/roles/{id}", 1L)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    @DisplayName("POST /api/ref/roles - create for ADMIN")
    @WithMockUser(roles = "ADMIN")
    void testCreate() throws Exception {
        ...
        RoleResponseDto responseDto = new RoleResponseDto(1L, "TEST_CODE", "Test Name");
        when(service.create(createDto)).thenReturn(responseDto);

        mockMvc.perform(post("/api/ref/roles")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @DisplayName("PUT /api/ref/roles/{id} - update for ADMIN")
    @WithMockUser(roles = "ADMIN")
    void testUpdate() throws Exception {
        ...
        RoleResponseDto responseDto = new RoleResponseDto(1L, "NEW_CODE", "New Name");
        when(service.update(1L, updateDto)).thenReturn(responseDto);

        mockMvc.perform(put("/api/ref/roles/{id}", 1L)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @DisplayName("DELETE /api/ref/roles/{id} - delete for ADMIN")
    @WithMockUser(roles = "ADMIN")
    void testDelete() throws Exception {
        doNothing().when(service).delete(1L);

        mockMvc.perform(delete("/api/ref/roles/{id}", 1L)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    @DisplayName("POST /api/ref/roles/filter - success for ADMIN")
    @WithMockUser(roles = "ADMIN")
    void testGetWithFilters() throws Exception {
        ...
        RoleResponseDto dto = new RoleResponseDto(1L, "TEST_CODE", "Test Name");
        when(service.getRolesWithFilters(request)).thenReturn(List.of(dto));

        mockMvc.perform(post("/api/ref/roles/filter")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        verify(service, times(1)).getRolesWithFilters(request);
    }
}
